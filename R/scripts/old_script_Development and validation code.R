# Older version of the script. Kept for our own record. 
# Most content in this script was checked against other group members' code.
# The .qmd documents contain the final code used for analysis. 
